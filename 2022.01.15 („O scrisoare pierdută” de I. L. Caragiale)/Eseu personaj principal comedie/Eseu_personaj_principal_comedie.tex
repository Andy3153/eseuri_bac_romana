...
\newcommand{\operatitle}{\textbf{\textit{„O scrisoare pierdută”\ }}} % title of the commented opera
\newcommand{\operaauthor}{I. L. Caragiale\ } % author of the commented opera
...
\marginnote{numele personajului}[0.8cm]
