...
% Custom commands
% Format: \newcommand{\command}[variable]{action #variable (add '\ ' or '{}' if it won't add a space properly)}
...
\newcommand{\operatitle}{\textbf{\textit{\ }}}                       % title of text
\newcommand{\operaauthor}{\ }                                        % author of text
