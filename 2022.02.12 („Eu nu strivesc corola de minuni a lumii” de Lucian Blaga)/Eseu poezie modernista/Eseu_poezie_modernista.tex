...
\newcommand{\operatitle}{\textbf{\textit{„Eu nu strivesc corola de minuni a lumii”\ }}} % title of the commented opera
\newcommand{\operaauthor}{Lucian Blaga\ } % author of the commented opera
